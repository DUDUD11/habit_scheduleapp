...
import com.example.ticktick2.databinding.FragmentHabitsadd4Binding;
import com.google.android.material.bottomnavigation.BottomNavigationView;

public class HabitAddFragment4 extends  Fragment{

    private FragmentHabitsadd4Binding binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        binding = FragmentHabitsadd4Binding.inflate(inflater, container, false);
        View root = binding.getRoot();

        final TextView textView = binding.textView;
     //   habitViewModel.getText().observe(getViewLifecycleOwner(), textView::setText);
        Log.d("create", "habitadd4");
