...
import com.example.ticktick2.databinding.FragmentHabitsadd3Binding;
import com.google.android.material.bottomnavigation.BottomNavigationView;

public class HabitAddFragment3 extends  Fragment{

    private FragmentHabitsadd3Binding binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        binding = FragmentHabitsadd3Binding.inflate(inflater, container, false);
        View root = binding.getRoot();

        final TextView textView = binding.textView;
       // habitViewModel.getText().observe(getViewLifecycleOwner(), textView::setText);
        Log.d("create", "habitadd3");
