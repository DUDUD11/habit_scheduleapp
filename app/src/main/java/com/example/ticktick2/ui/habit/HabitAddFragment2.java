...
import com.example.ticktick2.databinding.FragmentHabitsadd2Binding;
import com.google.android.material.bottomnavigation.BottomNavigationView;

public class HabitAddFragment2 extends Fragment {

    private FragmentHabitsadd2Binding binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        binding = FragmentHabitsadd2Binding.inflate(inflater, container, false);
        View root = binding.getRoot();

        MainActivity activity = (MainActivity) getActivity();
        NavController navContfaroller = activity.navController;

        final TextView textView = binding.textView;
 //       habitViewModel.getText().observe(getViewLifecycleOwner(), textView::setText);
        Log.d("create", "habitadd2");
